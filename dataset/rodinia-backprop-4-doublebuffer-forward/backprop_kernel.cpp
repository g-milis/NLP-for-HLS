...
L4:    float l1_buf[65536];

L5:    float conn_buf_x[TILE_SIZE][16];

L6:    float conn_buf_y[TILE_SIZE][16];
...
L8:    LOOP1: for (kk = 0; kk < 65536+TILE_SIZE; kk += TILE_SIZE) {
