...
{
/*L1:*/  prob_t llike[N_OBS][N_STATES];
  step_t t;
  state_t prev, curr;
  prob_t min_p, p;
  state_t min_s, s;
...
/*L7:*/  L_backtrack: for( t=N_OBS-2; t>=0; t-- ) {
    min_s = 0;
